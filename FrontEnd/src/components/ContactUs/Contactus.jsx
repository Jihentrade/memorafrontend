...
const ContactUsPage = () => {
  ...
  const structuredData = {
    ...
    "description": "Contactez-nous pour toute question concernant vos magnets photo personnalisés",
    "mainEntity": {
      "@type": "Organization",
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Téléphone",
      content: "+ 216 99 616 660 ",
      description: "Lun-Ven, 9h-18h",
    },
    {
      icon: <LocationIcon sx={{ color: "#176B87", fontSize: 40 }} />,
      title: "Adresse",
      content: "Rue Jeddah Msaken Sousse 4070",
  ...
  return (
    <>
      <Helmet>
        <title>Contact - Magnets Photo Personnalisés | Service Client Réactif</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Contact - Magnets Photo Personnalisés" />
        <meta
        ...
        <meta name="twitter:title" content="Contact - Magnets Photo Personnalisés" />
        <meta
