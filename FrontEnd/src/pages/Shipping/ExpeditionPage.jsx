...
const ExpeditionPage = () => {
  ...
  const structuredData = {
    ...
    description:
      "Service de livraison rapide et sécurisé pour vos magnets photo personnalisés",
    deliveryTime: {
  ...
  const avantagesLivraison = [
    {
      ...
      description:
        "Délai de livraison de 2 à 5 jours ouvrés en France métropolitaine",
    },
    {
      icon: <SecurityIcon sx={{ color: "#176B87", fontSize: 40 }} />,
      title: "Emballage Sécurisé",
      description:
        "Vos magnets sont soigneusement emballés pour garantir leur protection",
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>
          Livraison - Magnets Photo Personnalisés | Expédition Rapide et
          Sécurisée
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Livraison - Magnets Photo Personnalisés"
        />
        <meta
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              Un service de livraison rapide et sécurisé pour vos magnets photo
              personnalisés
            </Typography>
          </Box>
          ...
          >
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                ...
                >
                  • France métropolitaine : 2-5 jours ouvrés
                  <br />
                  • Europe : 5-10 jours ouvrés
                  <br />• International : 10-15 jours ouvrés
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography
                ...
                >
                  ...
                  <br />
                  • International : 19.99€
                  <br />• Livraison gratuite à partir de 50€ d'achat
                </Typography>
              </Grid>
            </Grid>
          </Box>
